...
import Bold, { BoldPlugin } from "../slate-icon-bold/src/index";
import Underline, { UnderlinePlugin } from "../slate-icon-underline/src/index";
import { ParagraphPlugin } from "../slate-icon-shared/src/index";
