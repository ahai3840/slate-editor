...
var Undo = function (_React$Component) {
  _inherits(Undo, _React$Component);

  function Undo(props) {
    _classCallCheck(this, Undo);

    var _this = _possibleConstructorReturn(this, (Undo.__proto__ || Object.getPrototypeOf(Undo)).call(this, props));
    ...
    _this.typeName = _this.props.type || 'undo';
    return _this;
  }
