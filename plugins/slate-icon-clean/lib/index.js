  ...
  return {
    onKeyDown: function onKeyDown(event, change) {
      if ((0, _isHotkey2.default)('ctrl+opt+n', event)) {
        return (0, _slateHelperMarkRemoveall2.default)(change);
      }
    }
  };
};
...
var Clean = function (_React$Component) {
  ...
  function Clean(props) {
    ...
    _this.onClick = function (e) {
      ...
      e.preventDefault();
      onChange((0, _slateHelperMarkRemoveall2.default)(change));
    };
  ...
  _createClass(Clean, [{
    ...
    value: function render() {
      ...
      return React.createElement(_slateIconShared2.default, _extends({
        type: this.typeName,
        icon: icon || 'Clean',
        onClick: onClick
      }, rest));
