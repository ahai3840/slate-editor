...
var _imageNode = require('@canner/slate-editor-renderer/lib/imageNode');
  ...
  _createClass(ImageInline, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(_slateIconShared2.default, _extends({
          type: this.typeName,
          icon: icon || 'Image',
          onClick: onClick,
          isActive: false
        }, rest)),
        React.createElement(_imageUpload2.default, {
