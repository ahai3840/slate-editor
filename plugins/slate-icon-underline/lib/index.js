...
var UnderlinePlugin = exports.UnderlinePlugin = function UnderlinePlugin(opt) {
  ...
  return (0, _slateIconShared.markPlugin)(options, 'cmd+u');
};
var Underline = (_dec = (0, _slateIconShared.markDecorator)(_marks.UNDERLINE, 'Underline'), _dec(_class = function (_Component) {
