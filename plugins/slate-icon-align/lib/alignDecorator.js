...
var _slateHelperBlockAdddata = require('@canner/slate-helper-block-adddata');

var _slateHelperBlockAdddata2 = _interopRequireDefault(_slateHelperBlockAdddata);

var _slateHelperBlockCleardatabykey = require('@canner/slate-helper-block-cleardatabykey');

var _slateHelperBlockCleardatabykey2 = _interopRequireDefault(_slateHelperBlockCleardatabykey);
...
var applyChange = exports.applyChange = function applyChange(change, type, align) {
  var isActive = (0, _slateUtilHave.haveDataKeyEqualValueInSomeBlocks)(change, type, align);

  if (isActive) return change.call(_slateHelperBlockCleardatabykey2.default, type);
  return change.call(_slateHelperBlockAdddata2.default, { data: _defineProperty({}, type, align) });
};
